...
column.numeric <- function(column){
  return(as.numeric(substr(column, 2, 2)))
}

##8-95, 97, 99-122, 124-152, 154-157, 163-173 need to be converted to numbers
...
pt5 <- as.data.frame(lapply(wk1[c(154:157)], column.numeric))

pt6 <- as.data.frame(lapply(wk1[c(163:173)], column.numeric))
...
full <- as.data.frame(lapply(full[c(1:157)], column.clean))
